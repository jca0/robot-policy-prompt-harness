...
class Terminations:
    ...
    success = DoneTerm(
        ...
        params={"object": "butter", "container": "grey_bin", "tolerance": 0.02, "require_gripper_detached": True},
    )


@dataclass
class SmallerObjectButterInBinTask(Task):
    ...
    instruction = {
        ...
        "specific": "Compare the objects on the table, identify the smaller one, and place it in the grey bin",
    }
