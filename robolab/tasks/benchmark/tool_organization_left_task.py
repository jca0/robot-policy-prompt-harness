...
class Terminations:
    ...
    success = DoneTerm(func=object_in_container, params={"object": ["red_hammer", "husky_hammer"], "container": "left_bin", "logical": "all", "require_gripper_detached": True})

@dataclass
class HammersInLeftBinTask(Task):
