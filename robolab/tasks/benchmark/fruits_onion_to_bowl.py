...
@configclass
class FruitsOnionTerminations:
    """Termination configuration for banana task."""
    time_out = DoneTerm(func=mdp.time_out, time_out=True)
    success = DoneTerm(
        func=object_in_container,
        params={"object": ["redonion"], "container": "wooden_bowl", "logical": "all", "tolerance": 0.0, "require_contact_with": True, "require_gripper_detached": True}
    )

@dataclass
class FruitsOnionTask(Task):
    ...
    terminations = FruitsOnionTerminations
    instruction = {
